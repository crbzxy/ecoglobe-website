...
class FormPanelAire extends Component {
  ...
  handleSubmit(event) {
    ...
    axios({
      ...
      url: "http://localhost:5000/PanelMasAire",
      data: this.state,
    }).then((response) => {
    ...
    return (
      <div className="FormularioPanelAire">
        ...
        >
          ...
          <div><label htmlFor="file">Foto de recibo:</label>
            <input
              id="file-PanelMasAir"
              type="file"
              name="file"
          ...
          <small>
            Al enviar este formulario, se le agregará a nuestra lista de correo y doy por entendido que acepto las condiciones de uso del servicio y la política de privacidad
          </small>
