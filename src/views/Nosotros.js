    ...
    <div className=' contenedor Nosotros'>
      <section className='contenedor-nosotros'>
        ...
        <div className='col'>
          <div className='texto'>
            ...
            <p>
              Pioneros en Energía Solar en Baja California, con más de 10 años
              de experiencia en el sector, estamos comprometidos con la
              transición a una economía de energía limpia en la región. Nuestra
              prioridad es ofrecerte las mejores soluciones en ahorro de
              energía, con la mejor relación calidad-precio en el mercado.
            </p>
          </div>
        </div>
        <div className='col'>
          ...
          <p>
            Nuestra prioridad es ofrecerte las mejores soluciones en ahorro de
            energía, con la mejor relación calidad-precio en el mercado.
          </p>
        </div>
        <div className='col'>
      ...
      <div className='Nosotros-mision'>
        <div className='col'>
          ...
          <p>
            Ofrecer soluciones innovadoras de ahorro de energía para satisfacer
            las necesidades de nuestros clientes y contrubuir en la transición
            hacia una economía de energía limpia en México.
          </p>
        </div>
        <div className='col'>
          <div className='titulo'>VISIÓN</div>
          <p>
            Ser la mejor opción y continuar siendo pioneros en soluciones
            innovadoras de ahorro de energía en el mercado de Baja California.
          </p>
        </div>
        ...
        <div className='row d-flex flex-wrap'>
          <div className='col-12'>
            <Iframe
              width='580'
              height='600'
              src='https://www.youtube.com/embed/wFaa9e7auzM?controls=0&amp;start=106'
              title='Ecoglobe'
              frameborder='0'
