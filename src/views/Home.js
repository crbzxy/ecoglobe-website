          ...
          <section className='contenedor-nosotros'>
            ...
            <div className='col'>
              <div className='texto'>
                ...
                <p>
                  Pioneros en Energía Solar en Baja California, con más de 10
                  años de experiencia en el sector, estamos comprometidos con la
                  transición a una economía de energía limpia en la región.
                  Nuestra prioridad es ofrecerte las mejores soluciones en
                  ahorro de energía, con la mejor relación calidad-precio en el
                  mercado.
                </p>
              </div>
            </div>
          ...
          <section className='contenedor-cards'>
            ...
            <div className='card'>
              ...
              <div className='texto'>
                ...
                <p className='descripcion'>
                  Funcionan con baterías para lugares en donde no hay conexión
